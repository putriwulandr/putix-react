...
export function CodeBlock({ code, filename = 'example.tsx' }: CodeBlockProps) {
  ...
  return (
    <div style={{ background: '#fafafa', border: '1px solid #ebebeb', borderRadius: '12px', overflow: 'hidden' }}>
      <div style={{ padding: '10px 16px', borderBottom: '1px solid #ebebeb', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <span style={{ fontFamily: "'Courier New', monospace", fontSize: '0.62rem', color: '#aaa', marginLeft: '8px', letterSpacing: '0.08em' }}>
            {filename}
          </span>
        </div>
